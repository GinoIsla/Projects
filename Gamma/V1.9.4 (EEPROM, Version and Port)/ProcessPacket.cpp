...
//====================================================================================
			...
			if (newIp[0] == VAL_CODE) {
				...
				strcpy(final_string.data_chars + string_length(final_string.data_chars), itoa(Server_Port_Id.whole_word, asc_val, 10)); // header
				
				strcpy(final_string.data_chars  + string_length(final_string.data_chars), "]");

			}			
			else {
				strcpy(final_string.data_chars, no_valid_Port);
			}
