...
// *************************************************************************************************************
// get_client_port():
// Read this device's client port from EEPROM
...
// Start the server (to liten for commands)
...
bool init_TCPIP_connections() {
		...
		Dest_Server_Port = get_server_port();			// gets the port ID for this controller's client (to send reports to the server)
		
		server = EthernetTcpServer(get_client_port());		// read the server from EEPROM
...
// Called from idle loop, no conditions
// *************************************************************************************************************
void CheckTCPComms(){
...
//											main();
//**********************************************************************************************************
//REMINDER: UPDATE VERSION NUMBER - now (Version: 01.09.6b)
//**********************************************************************************************************
