...
//====================================================================================
//		else if (strcmp(parsed_command.name,"SetClientIP") == 0){		// name changed
		else if (strcmp(parsed_command.name,"SetClearCoreIP") == 0){
...
//		else if (strcmp(parsed_command.name,"SetServerIP") == 0){
		else if (strcmp(parsed_command.name,"SetDesktopServerIP") == 0){
			if (parsed_command.val1 == 0xff || parsed_command.val2 == 0xff){
				strcpy(final_string.data_chars, out_of_range);
			}
			else {
...
//		else if (strcmp(parsed_command.name,"GetClientIP") == 0){
		else if (strcmp(parsed_command.name,"GetClearCoreIP") == 0){
...
//		else if (strcmp(parsed_command.name,"GetServerIP") == 0){
		else if (strcmp(parsed_command.name,"GetDesktopServerIP") == 0){
...
//====================================================================================
		else if (strcmp(parsed_command.name,"SetDesktopServerPort") == 0){
...
//====================================================================================
		else if (strcmp(parsed_command.name,"GetDesktopServerPort") == 0){
			char asc_val[8];
			
			strcpy(final_string.data_chars  - 2 + string_length(final_string.data_chars), "|Port ID=");
			strcpy(final_string.data_chars + string_length(final_string.data_chars), itoa(get_server_port(), asc_val, 10));			
			strcpy(final_string.data_chars  + string_length(final_string.data_chars), "]");

		}
//====================================================================================
//		new in 1.9.5
	else if (strcmp(parsed_command.name,"SetClearCorePort") == 0){
		if (parsed_command.val1 == 0xffff){
			strcpy(final_string.data_chars, Par_missing);
		}
	else {
		...
		newIp[0] = Server_Port_Id.bytes.low_byte;
		newIp[1] = Server_Port_Id.bytes.high_byte;
		write_SEEPROM(Client_Port_valid, &VAL_CODE, 1);
		write_SEEPROM(Client_Port_EEPROM, &Server_Port_Id.bytes.low_byte, 1);
		write_SEEPROM(Client_Port_EEPROM+1, &Server_Port_Id.bytes.high_byte, 1);
	}
}
//====================================================================================
//		new in 1.9.5
	else if (strcmp(parsed_command.name,"GetClearCorePort") == 0){
	char asc_val[8];
	
		strcpy(final_string.data_chars  - 2 + string_length(final_string.data_chars), "|Port ID=");
		strcpy(final_string.data_chars + string_length(final_string.data_chars), itoa(get_client_port(), asc_val, 10));	
		strcpy(final_string.data_chars  + string_length(final_string.data_chars), "]");
}

//====================================================================================
//		new in 1.9.5a
	else if (strcmp(parsed_command.name,"GetHearbeatInterval") == 0){
		char asc_val[8];
	
	//	Server_Port_Id.whole_word = 0;
		strcpy(final_string.data_chars  - 2 + string_length(final_string.data_chars), "|Interval=");
		read_SEEPROM(Interval_valid, newIp);
	
		if (newIp[0] == VAL_CODE) {
			read_SEEPROM(Heartbit_Interval_EEPROM, newIp);		// reads bytes, convert to word
			Server_Port_Id.whole_word = (int) newIp[0];
			...
			strcpy(final_string.data_chars + string_length(final_string.data_chars), itoa(interval_count / 3, asc_val, 10));
		}
...
//====================================================================================
		else if (strcmp(parsed_command.name,"SetHearbeatInterval") == 0)
		{
			if (parsed_command.val1 == 0xffff){
				strcpy(final_string.data_chars, Par_missing);
			}
			else if(parsed_command.val1 > 255){
				
				strcpy(final_string.data_chars, Par_error);
			}
			else {
				Server_Port_Id.whole_word = parsed_command.val1;		// re-using Server_Port_Id to separate bytes
				newIp[0] = Server_Port_Id.bytes.low_byte;
				newIp[1] = Server_Port_Id.bytes.high_byte;
						
				write_SEEPROM(Interval_valid, &VAL_CODE, 1);
				write_SEEPROM(Heartbit_Interval_EEPROM, &newIp[1], 1);
			}
			interval_count = Server_Port_Id.whole_word * 3; // sent at 300 * 3 ms 
		}
