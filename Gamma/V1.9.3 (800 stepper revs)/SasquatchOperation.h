...
uint8_t *SmartEEPROM8 = (uint8_t *) SEEPROM_ADDR; // virtual start address 0x44000000
...
#define CAM_SAFE_POS 800							// when hitting the sensors, go back one whole revolution
#define LENS_SAFE_POS 800
