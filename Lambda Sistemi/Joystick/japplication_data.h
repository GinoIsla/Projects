...
#define EEPROM_number_rx_nodes		22	//1
#define EEPROM_SWITCH1				23	//1
#define EEPROM_POT_RX_ID1			24	//1
#define EEPROM_POT_RX_ID2			25	//1
#define EEPROM_POT_RX_ID3			26	//1
#define EEPROM_POT_RX_ID4			27	//1

#define EE_CS			PORTCbits.RC7
#define PDOS_ENABLED	0b00011111
...
#define PDO_COUNT 4000
#define MASTER_OR_SLAVE	TRUE	//true -> master, false -> slave

typedef union PDO_Enable
{
	struct
	{
	unsigned SwitchBank1:1;
	unsigned Pot1:1;
	unsigned Pot2:1;
	unsigned Pot3:1;
	unsigned Pot4:1;
