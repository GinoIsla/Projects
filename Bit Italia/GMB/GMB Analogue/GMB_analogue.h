...
;
;clock 4MHz
;#defin	C_BIT_0					91		;Duration (in clock ticks) of a '0' byte
;#defin	C_BIT_1					63		;Duration (in clock ticks) of a '1' byte
;#defin	C_BIT_SUP				120		;Max limit of of a bit during reception/transmission
